...
extern Il2CppClass* Physics2D_t9846735_il2cpp_TypeInfo_var;
extern const uint32_t Physics2D_OverlapPoint_m1741297912_MetadataUsageId;
extern "C"  Collider2D_t1552025098 * Physics2D_OverlapPoint_m1741297912 (Il2CppObject * __this /* static, unused */, Vector2_t4282066565  ___point0, int32_t ___layerMask1, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
		il2cpp_codegen_initialize_method (Physics2D_OverlapPoint_m1741297912_MetadataUsageId);
		s_Il2CppMethodIntialized = true;
	}
	float V_0 = 0.0f;
	float V_1 = 0.0f;
	{
		...
		Collider2D_t1552025098 * L_3 = Physics2D_INTERNAL_CALL_OverlapPoint_m467114293(NULL /*static, unused*/, (&___point0), L_0, L_1, L_2, /*hidden argument*/NULL);
		return L_3;
	}
}
...
extern "C"  Collider2D_t1552025098 * Physics2D_INTERNAL_CALL_OverlapPoint_m467114293 (Il2CppObject * __this /* static, unused */, Vector2_t4282066565 * ___point0, int32_t ___layerMask1, float ___minDepth2, float ___maxDepth3, const MethodInfo* method)
{
	typedef Collider2D_t1552025098 * (*Physics2D_INTERNAL_CALL_OverlapPoint_m467114293_ftn) (Vector2_t4282066565 *, int32_t, float, float);
	static Physics2D_INTERNAL_CALL_OverlapPoint_m467114293_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (Physics2D_INTERNAL_CALL_OverlapPoint_m467114293_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.Physics2D::INTERNAL_CALL_OverlapPoint(UnityEngine.Vector2&,System.Int32,System.Single,System.Single)");
